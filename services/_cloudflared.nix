  ...
  systemd.services = {
    "cloudflared-route-tunnel" = {
      ...
      serviceConfig = {
        ...
        ExecStart = "${lib.getExe pkgs.cloudflared} tunnel route dns 'lightlab-01' 'watch.balticumvirtus.com'; ${lib.getExe pkgs.cloudflared} tunnel route dns 'lightlab-01' 'cloud.balticumvirtus.com'";
      };
    };
  };
}
