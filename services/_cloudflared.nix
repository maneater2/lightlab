    ...
    "cloudflared-route-tunnel" = {
      ...
      serviceConfig = {
        ...
        ExecStart = ''
         ...
         ${lib.getExe pkgs.cloudflared} tunnel route dns 'lightlab-01' 'miniflux.balticumvirtus.com' &&
         ${lib.getExe pkgs.cloudflared} tunnel route dns 'lightlab-01' 'dav.balticumvirtus.com' &&
